...
class student:
    def __init__(self,root):
       ...
       #------------------------------manage  frame ---------------------------------------------------------------------------
        ...
        m_frame=Frame(self.root,bd=4,relief=RIDGE, bg="blue")
        m_frame.place(x=20,y=100,width=450,height=600)

        m_title=Label(m_frame,text="Manage Students",bg="blue",fg="white",font=("times new roman",30,"bold"))
        m_title.grid(row=0,columnspan=2,pady=20)


        lbl_roll=Label(m_frame,text="Roll No. :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_name=Label(m_frame,text="Name :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_email=Label(m_frame,text="Email :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_Gender=Label(m_frame,text="Gender :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_cnt=Label(m_frame,text="Contact :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_dob=Label(m_frame,text="D.O.B. :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        lbl_address=Label(m_frame,text="Address :",bg="blue",fg="white",font=("times new roman",20,"bold"))
        ...
        btn_frame=Frame(m_frame,bd=4,relief=RIDGE, bg="blue")
       ...
       #-----------------------detail   frame ---------------------------------------------------------------------------------------------
        ...
        d_frame=Frame(self.root,bd=4,relief=RIDGE, bg="blue")
        d_frame.place(x=500,y=100,width=850,height=600)

        lbl_name=Label(d_frame,text="Students Details:",bg="blue",fg="white",font=("times new roman",30,"bold"))
        lbl_name.grid(row=0,column=0,pady=10,padx=20,sticky="w")


      #----------------------------------------------------table frame right side--------------------------------------------------------------------------

        t_frame=Frame(d_frame,bd=4,relief=RIDGE, bg="blue")
        ...
        j_frame=Frame(self.root,relief=RIDGE,bg="blue")
        j_frame.place(x=1100,y=640,width=220,height=40)
        lbl_t=Label(j_frame,text="""Developed By: Himanshu Prajapati
Email : himanshu2003prajapati@gmail.com""",fg="black",bg="blue",font=("times new roman",10))
